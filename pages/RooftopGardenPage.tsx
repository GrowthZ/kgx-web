            ...
            <main className="flex flex-col items-center">
                ...
                <section className="w-full max-w-[1200px] px-4 md:px-8 pt-16 pb-12">
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 text-sm text-text-muted dark:text-gray-400 mb-2  font-bold tracking-wider">
                            <span>Dịch vụ</span>
                            <span className="material-symbols-outlined text-xs">chevron_right</span>
                            <span className="text-primary dark:text-accent">Thiết kế cảnh quan</span>
                        </div>
                        <h1 className="text-3xl md:text-5xl font-black tracking-normal text-text-main dark:text-white ">
                ...
                <section className="w-full max-w-[1200px] px-4 md:px-8 py-16">
                    <h2 className="text-2xl font-black  tracking-normal mb-12 border-l-8 border-primary pl-6 dark:text-white">
                ...
                <section className="w-full bg-white dark:bg-background-dark py-20 border-y border-primary/10 dark:border-white/10">
                    <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                        <h2 className="text-2xl font-black  tracking-normal mb-12 border-l-8 border-accent pl-6 dark:text-white">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            <div className="flex flex-col gap-8 order-2 lg:order-1">
                                ...
                                <div className="pt-6">
                                    <button className="h-14 px-10 rounded-xl bg-primary text-white text-base font-black  transition-all hover:bg-primary/90 shadow-xl shadow-primary/20">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-8">
                                    <div className="bg-white/95 dark:bg-black/90 backdrop-blur-md p-6 rounded-2xl border border-white/50 max-w-xs shadow-2xl">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <span className="text-xs font-black text-primary  tracking-widest">Cấu tạo tiêu chuẩn</span>
                                        </div>
                    ...
                    <div className="max-w-[1200px] mx-auto bg-primary rounded-3xl overflow-hidden shadow-2xl relative">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-12 md:p-16 gap-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 shrink-0">
                                <button className="h-14 px-10 rounded-xl bg-white text-primary text-lg font-black  hover:bg-gray-100 transition-all shadow-2xl">
                                    Nhận tư vấn ngay
                                </button>
                                <button className="h-14 px-10 rounded-xl bg-accent text-white text-lg font-black  hover:bg-accent/90 transition-all shadow-2xl">
