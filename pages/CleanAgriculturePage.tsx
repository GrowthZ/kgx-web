            ...
            <main className="flex-grow w-full flex flex-col items-center">
                ...
                <section className="w-full pt-20 pb-12 px-6 max-w-[1200px]">
                    <div className="flex flex-col gap-4 text-center md:text-left">
                        ...
                        <h1 className="text-3xl md:text-5xl font-black text-[#151712] dark:text-white tracking-normal">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div className="flex flex-col gap-12 order-2 lg:order-1">
                                <div className="space-y-6">
                                    ...
                                    <h4 className="text-3xl md:text-4xl font-black text-[#151712] dark:text-white  tracking-normal">Canh tác <br />& tự động hóa</h4>
