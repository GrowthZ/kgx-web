...
const CleanAgriculturePage: React.FC = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = "Thi công Nông nghiệp sạch - KGX Landscape";
    }, []);
            ...
            <main className="flex-grow w-full flex flex-col items-center">
                ...
                <section className="w-full pt-20 pb-12 px-6 max-w-[1200px]">
                    <div className="flex flex-col gap-4 text-center md:text-left">
                        <span className="text-primary dark:text-accent font-black text-sm tracking-[0.4em] uppercase">Dịch vụ chuyên sâu</span>
                        <h1 className="text-4xl md:text-6xl font-black text-[#151712] dark:text-white leading-tight uppercase tracking-tight">
                ...
                <section className="w-full py-16 px-6 max-w-[1200px]">
                    <div className="flex items-center gap-6 mb-16">
                        <h3 className="text-2xl font-black uppercase tracking-widest text-[#151712] dark:text-white flex-shrink-0">
                            ĐẶC THÙ THI CÔNG
                        </h3>
                        ...
                        {[
                            ...
                            <div key={i} className="group relative flex flex-col gap-8 p-10 rounded-[40px] bg-white dark:bg-[#34382e] shadow-2xl border border-primary/5 dark:border-white/5 hover:border-primary/20 transition-all duration-700">
                                ...
                                <div className="flex flex-col gap-4">
                                    <h4 className="text-2xl font-black text-[#151712] dark:text-white uppercase tracking-tight">{card.title}</h4>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div className="flex flex-col gap-12 order-2 lg:order-1">
                                <div className="space-y-6">
                                    <span className="text-accent font-black tracking-[0.3em] text-xs uppercase block">Giải pháp tối ưu</span>
                                    <h4 className="text-4xl md:text-5xl font-black text-[#151712] dark:text-white uppercase tracking-tight leading-tight">Canh tác <br />& Tự động hóa</h4>
                                ...
                                <div className="flex flex-col gap-10">
                                    {[
                                        ...
                                        <div key={i} className="flex gap-6 group">
                                            ...
                                            <div>
                                                <h5 className="text-xl font-black text-[#151712] dark:text-white uppercase tracking-tight">{sol.title}</h5>
                                ...
                                <div className="pt-6 border-t border-primary/10 dark:border-white/10">
                                    <button className="h-14 px-8 bg-primary dark:bg-accent text-white font-black uppercase text-xs tracking-widest rounded-xl shadow-2xl hover:shadow-primary/30 transition-all">
                            ...
                            <div className="relative order-1 lg:order-2 h-[540px] lg:h-[640px] w-full rounded-[48px] overflow-hidden shadow-2xl border-8 border-stone-50 dark:border-white/5 group">
                                ...
                                <div className="absolute bottom-10 left-10 right-10 z-20 bg-white/95 dark:bg-black/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border-l-[12px] border-accent">
                                    <span className="text-xs font-black text-accent uppercase tracking-[0.4em] block mb-3">Dự án tiêu biểu</span>
                                    <p className="text-2xl font-black text-primary dark:text-white uppercase tracking-tight">Hệ thống nhà màng Farmstay <br />Hòa Bình - 2.5ha</p>
                                </div>
                            </div>
                        </div>
                    </div>
