            ...
            <main className="flex-grow">
                ...
                <section className="py-20 bg-stone-50 dark:bg-[#30352c] border-b border-[#eef0ea] dark:border-white/5 relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10 text-center">
                        ...
                        <h1 className="text-2xl md:text-4xl lg:text-5xl font-black text-text-main dark:text-white leading-[1.8] mb-8  tracking-normal">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={i} className="group bg-stone-50 dark:bg-[#3a4035] p-10 rounded-3xl border border-transparent hover:border-primary/20 dark:hover:border-accent/30 shadow-card hover:shadow-2xl transition-all duration-500 relative overflow-hidden text-center">
                                    ...
                                    <h3 className="text-xl font-bold text-text-main dark:text-white mb-4  tracking-normal">{card.title}</h3>
                        ...
                        <div className="flex flex-col lg:flex-row gap-16 items-center">
                            <div className="lg:w-1/2 flex flex-col gap-10 order-2 lg:order-1">
                                <div>
                                    ...
                                    <h2 className="text-3xl md:text-4xl font-black text-text-main dark:text-white leading-[1.8] mb-8  tracking-normal">
                                ...
                                <div className="space-y-8">
                                    {[
                                        ...
                                        <div key={i} className="flex gap-6">
                                            ...
                                            <div>
                                                <h4 className="text-xl font-bold text-text-main dark:text-white  tracking-normal">{sol.title}</h4>
                            ...
                            <div className="lg:w-1/2 w-full order-1 lg:order-2">
                                <div className="relative rounded-[40px] overflow-hidden shadow-2xl aspect-[4/5] group border-8 border-background-light dark:border-white/5">
                                    ...
                                    <div className="absolute bottom-10 left-10 p-4 border-l-4 border-accent text-white">
                                        <p className="text-xs font-black  tracking-widest text-accent mb-2">Dự án tiêu biểu</p>
                ...
                <section className="py-24 bg-background-light dark:bg-[#30352c]">
                    <div className="container mx-auto px-6">
                        <div className="text-center mb-20">
                            <span className="text-primary dark:text-accent font-black  tracking-[0.4em] text-xs mb-4 block">Standardized Workflow</span>
                            <h2 className="text-3xl md:text-4xl font-black text-text-main dark:text-white  tracking-normal">Quy trình triển khai</h2>
                        </div>
                            ...
                            {[
                                ...
                                <div key={i} className="flex flex-col items-center text-center group">
                                    <div className="size-28 bg-white dark:bg-[#3a4035] rounded-full flex items-center justify-center mb-8 shadow-xl relative transition-transform duration-500 group-hover:-translate-y-2 border-4 border-stone-50 dark:border-white/5">
                                        <span className="material-symbols-outlined text-3xl text-primary dark:text-accent">{step.icon}</span>
                                    ...
                                    <h3 className="text-2xl font-bold text-text-main dark:text-white mb-4  tracking-normal">{step.title}</h3>
                ...
                <section className="bg-primary py-24 relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10 text-center flex flex-col items-center">
                        <h2 className="text-3xl md:text-5xl font-black text-white mb-8 max-w-4xl leading-[1.8]  tracking-normal">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <button className="h-16 px-12 bg-white text-primary hover:bg-stone-50 text-lg font-black rounded-2xl shadow-2xl transition-all transform hover:-translate-y-1  tracking-widest">
                                Nhận báo giá ngay
                            </button>
                            <button className="h-16 px-12 bg-accent text-white hover:bg-orange-600 text-lg font-black rounded-2xl shadow-2xl shadow-orange-500/30 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3  tracking-widest">
