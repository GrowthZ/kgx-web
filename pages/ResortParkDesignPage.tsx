...
const ResortParkDesignPage: React.FC = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = "Thiết kế Resort & Công viên - KGX Landscape";
    }, []);
        ...
        <div className="bg-background-light dark:bg-background-dark text-[#151612] dark:text-gray-100 antialiased transition-colors duration-300">
            <main className="flex flex-col items-center">
                ...
                <section className="w-full pt-16 pb-12 bg-white dark:bg-[#30352c]">
                    <div className="mx-auto max-w-[1200px] px-4 md:px-8">
                        <div className="max-w-3xl">
                            <span className="inline-block py-1 px-3 rounded-full bg-primary/10 text-primary dark:bg-white/10 dark:text-white text-xs font-bold uppercase tracking-wider mb-4">Dịch vụ Cảnh Quan</span>
                            <h2 className="text-4xl md:text-5xl font-black tracking-tight text-[#151612] dark:text-white mb-6 leading-tight uppercase">
                ...
                <section className="w-full py-16 bg-white dark:bg-background-dark border-y border-primary/10 dark:border-white/10">
                    <div className="mx-auto max-w-[1200px] px-4 md:px-8">
                        <div className="mb-12">
                            <h3 className="text-2xl font-black text-[#151612] dark:text-white uppercase tracking-tight flex items-center gap-3">
                    ...
                    <div className="mx-auto max-w-[1200px] px-4 md:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            <div className="flex flex-col gap-8 order-2 lg:order-1">
                                <div>
                                    <h3 className="text-sm font-bold text-accent uppercase tracking-widest mb-2">Giá trị cốt lõi</h3>
                                    <h2 className="text-3xl md:text-4xl font-black text-[#151612] dark:text-white leading-tight mb-6 uppercase">
                                ...
                                <div className="relative h-[400px] lg:h-[600px] w-full rounded-2xl overflow-hidden shadow-2xl border border-primary/10 dark:border-white/10">
                                    ...
                                    <div className="absolute bottom-8 left-8 right-8 z-20">
                                        <div className="bg-white/95 backdrop-blur dark:bg-black/80 p-4 rounded-lg shadow-lg border-l-4 border-accent max-w-xs">
                                            <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Dự án tiêu biểu</p>
                ...
                <section className="w-full py-16 bg-white dark:bg-background-dark border-t border-primary/10 dark:border-white/10">
                    <div className="mx-auto max-w-[1200px] px-4 md:px-8">
                        <h2 className="text-3xl font-black text-[#151612] dark:text-white tracking-tight leading-tight uppercase mb-12">Phạm vi thiết kế chi tiết</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
