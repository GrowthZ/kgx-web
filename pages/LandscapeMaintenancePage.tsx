                ...
                <div className="w-full bg-background-light dark:bg-[#30352c] pt-16 pb-12 transition-colors">
                    <div className="mx-auto max-w-[1200px] px-6">
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center gap-2 text-sm font-bold text-accent  tracking-widest">
                ...
                <section className="py-20 bg-white dark:bg-background-dark relative overflow-hidden transition-colors">
                    ...
                    <div className="mx-auto max-w-[1200px] px-6 relative z-10">
                        <div className="mb-16 max-w-3xl">
                            <h2 className="text-2xl md:text-3xl font-black text-text-main dark:text-white mb-6  tracking-normal">
                            ...
                            {[
                                ...
                                <div key={i} className="group flex flex-col md:flex-row gap-8 p-10 rounded-3xl bg-background-light dark:bg-[#3a4035] border border-primary/10 dark:border-white/5 hover:border-primary/30 dark:hover:border-accent/30 hover:shadow-2xl transition-all duration-500">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        <h3 className="text-2xl font-bold text-text-main dark:text-white group-hover:text-primary dark:group-hover:text-accent transition-colors  tracking-normal">{card.title}</h3>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                            <div className="flex flex-col gap-10 order-2 lg:order-1">
                                    ...
                                    {[
                                        ...
                                        <div key={i} className="flex flex-col gap-2">
                                            <div className="flex items-center gap-3 text-primary dark:text-accent font-black">
                                                ...
                                                <h4 className="text-lg  tracking-normal">{service.title}</h4>
                                            </div>
                                ...
                                <div className="pt-4 border-t border-primary/10 dark:border-white/10">
                                    <button className="h-14 px-8 rounded-xl bg-primary dark:bg-accent text-white font-black  text-sm tracking-widest hover:shadow-2xl transition-all transform hover:-translate-y-1">
                                ...
                                <div className="relative overflow-hidden rounded-[32px] shadow-2xl aspect-[4/5] border-8 border-white dark:border-white/10">
                                    ...
                                    <div className="absolute bottom-8 left-8 right-8 text-white">
                                        <div className="flex items-center gap-3">
                                            <span className="material-symbols-outlined fill-1 text-accent text-3xl">verified</span>
                                            <div className="flex flex-col">
                                                <span className="text-lg font-black  tracking-normal">Kỹ thuật viên chuyên nghiệp</span>
                                                <span className="text-sm opacity-80  tracking-widest">&gt; 5 năm kinh nghiệm</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <section className="py-24 bg-white dark:bg-background-dark transition-colors border-y border-primary/5 dark:border-white/5">
                    <div className="mx-auto max-w-[1200px] px-6">
                        <div className="flex flex-col items-center text-center mb-16">
                            <span className="text-primary dark:text-accent font-black  tracking-[0.3em] text-xs mb-4">Gói dịch vụ</span>
                            <h2 className="text-3xl md:text-4xl font-black text-text-main dark:text-white  tracking-normal">Đối tượng phù hợp</h2>
                        </div>
                            ...
                            {[
                                ...
                                <div key={i} className="group relative bg-background-light dark:bg-[#3a4035] rounded-[32px] overflow-hidden border border-primary/10 dark:border-white/5 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                                    <div className="h-64 overflow-hidden relative">
                                        ...
                                        <div className="absolute top-6 right-6 px-4 py-1.5 bg-primary text-white text-[10px] font-black  tracking-widest rounded-full shadow-lg">
                                            {item.tag}
                                        </div>
                                    </div>
                                    <div className="p-8 pb-10">
                                        <h3 className="text-xl font-bold text-text-main dark:text-white mb-3  tracking-normal">{item.title}</h3>
