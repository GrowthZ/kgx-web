...
const TissueCultureBiotechPage: React.FC = () => {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-text-main dark:text-white flex flex-col min-h-screen font-display antialiased transition-colors duration-300">
            <SEO title="Nuôi cấy mô Công nghệ cao - KGX Biotech" />
            <main className="flex-grow">
                ...
                <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10 text-center">
                        ...
                        <h1 className="text-4xl md:text-6xl font-black text-white mb-8  tracking-normal drop-shadow-2xl">
                        ...
                        <div className="flex flex-col lg:flex-row gap-20 items-center">
                            <div className="lg:w-1/2 space-y-12 order-2 lg:order-1">
                                <div>
                                    ...
                                    <h2 className="text-3xl md:text-4xl font-black text-primary dark:text-white  tracking-normal">Tiêu chuẩn <br />vô trùng tuyệt đối</h2>
                                </div>
