        ...
        <div className="bg-background-light dark:bg-background-dark text-text-main flex flex-col min-h-screen">
            <main className="flex-grow">
                    ...
                    <div className="max-w-[1200px] mx-auto px-4 lg:px-0">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="flex flex-col gap-6">
                                <h1 className="text-3xl lg:text-4xl font-extrabold text-text-main leading-[1.8] tracking-normal ">
                                    {service.title}
                                </h1>
                            ...
                            <div className="relative group">
                                ...
                                <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden shadow-2xl">
                                    ...
                                    <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-lg shadow-sm">
                                        <p className="text-xs font-bold text-primary  tracking-wider">Thi công thực tế</p>
                                        <p className="text-sm font-semibold text-text-main">Chất lượng KGX - Không Gian Xanh</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="w-full py-10 bg-surface border-y border-[#eef0ea]">
                    <div className="max-w-[1200px] mx-auto px-4 lg:px-0">
                        <h2 className="text-xl font-bold text-text-main mb-6  tracking-normal">Dịch vụ phù hợp với</h2>
                            ...
                            <div className="max-w-[1200px] mx-auto px-4 lg:px-0">
                                <div className={`flex flex-col lg:flex-row gap-16 items-center ${!isEven ? 'lg:flex-row-reverse' : ''}`}>
                                    <div className="flex-1">
                                        ...
                                        <h2 className="text-2xl font-bold text-text-main mb-6  tracking-normal leading-[1.8]">
                                            {section.title}
                                        </h2>
                                        {section.description && (
                                        ...
                                        <div className="relative w-full aspect-square rounded-2xl overflow-hidden shadow-2xl">
                                            ...
                                            <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur rounded-lg p-5 shadow-lg border-l-4 border-primary transform transition-transform duration-500 hover:translate-y-[-5px]">
                                                <div className="flex items-center gap-3 mb-2">
                                                    ...
                                                    <span className="font-bold text-text-main">Tiêu chuẩn KGX - Không Gian Xanh</span>
                                                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                <div key={i} className="p-6 rounded-xl bg-background-light border border-[#eef0ea] hover:border-secondary/50 transition-colors">
                                    <span className="material-symbols-outlined text-3xl text-secondary mb-4">{feature.icon}</span>
                                    <h3 className="text-lg font-bold text-text-main mb-2  text-sm tracking-wide">{feature.title}</h3>
