...
const GreenConsultingPage: React.FC = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = "Tư vấn Giải pháp Xanh - KGX Landscape";
    }, []);
            ...
            <main className="flex-grow">
                ...
                <section className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-[1200px]">
                        <div className="mb-16 text-center max-w-3xl mx-auto">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-[#161811] dark:text-white leading-tight uppercase tracking-tight">
                            ...
                            {[
                                ...
                                <div key={i} className="group relative overflow-hidden rounded-[40px] h-[540px] shadow-2xl transition-all hover:-translate-y-2 duration-700">
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-10 flex flex-col items-start gap-4">
                                        ...
                                        <h3 className="text-3xl font-black text-white leading-tight uppercase tracking-tight">{card.title}</h3>
                                        <p className="text-gray-300 font-medium leading-relaxed italic">
                                            "{card.desc}"
                                        </p>
                                        <button className="mt-6 flex items-center gap-3 text-sm font-black text-accent uppercase tracking-widest hover:text-white transition-colors group/btn">
                    ...
                    <div className="mx-auto max-w-[1200px] px-6 lg:px-8">
                        <div className="grid lg:grid-cols-2 gap-20 items-center">
                            <div className="flex flex-col gap-10 order-2 lg:order-1">
                                <div>
                                    <h2 className="text-4xl sm:text-5xl font-black text-[#161811] dark:text-white mb-8 uppercase leading-tight tracking-tight">
                                ...
                                <div className="flex flex-col gap-10">
                                    {[
                                        ...
                                        <div key={i} className="flex gap-8 group">
                                            ...
                                            <div className="pb-4">
                                                <h3 className="text-2xl font-bold text-[#161811] dark:text-white mb-3 uppercase tracking-tight">{step.title}</h3>
                            ...
                            <div className="relative order-1 lg:order-2 h-[600px] lg:h-[700px] w-full rounded-[48px] overflow-hidden shadow-2xl border-8 border-stone-50 dark:border-white/5">
                                ...
                                <div className="absolute bottom-10 left-10 right-10 bg-white/95 dark:bg-black/80 backdrop-blur-xl p-8 rounded-3xl border-l-[12px] border-accent shadow-2xl">
                                    <div className="flex items-start gap-5">
                                        <span className="material-symbols-outlined text-primary dark:text-accent text-5xl">verified</span>
                                        <div>
                                            <p className="text-2xl font-black text-[#161811] dark:text-white uppercase tracking-tight">Cam kết chất lượng</p>
                ...
                <section className="relative py-24 px-6 lg:px-8 bg-primary overflow-hidden transition-colors">
                    ...
                    <div className="relative mx-auto max-w-[1000px] text-center flex flex-col items-center">
                        <h2 className="text-4xl sm:text-6xl font-black text-white mb-10 leading-tight uppercase tracking-tight">
                        ...
                        <div className="flex flex-col sm:flex-row gap-8 justify-center items-center w-full">
                            <button className="w-full sm:w-auto px-12 py-6 bg-white text-primary text-xl font-black rounded-2xl hover:bg-stone-50 transition-all shadow-2xl shadow-white/10 uppercase tracking-widest transform hover:-translate-y-2">
                                ĐĂNG KÝ TƯ VẤN NGAY
                            </button>
                            <button className="w-full sm:w-auto px-12 py-6 bg-accent text-white border-2 border-white/20 text-xl font-black rounded-2xl hover:shadow-2xl shadow-orange-500/30 transition-all flex items-center justify-center gap-4 uppercase tracking-widest transform hover:-translate-y-2">
